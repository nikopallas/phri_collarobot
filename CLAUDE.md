...
| Carriage position read | `/elmo/id2/carriage/position/get` (`std_msgs/Float32`)                              |
| Carriage position set  | `/elmo/id2/carriage/position/set` (`std_msgs/Float32`)                              |
| Lift position read     | `/elmo/id2/lift/position/get` (`std_msgs/Float32`)                                  |
| Lift position set      | `/elmo/id2/lift/position/set` (`std_msgs/Float32`)                                  |
